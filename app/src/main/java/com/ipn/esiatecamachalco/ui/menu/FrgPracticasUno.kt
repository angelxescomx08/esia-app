...
class FrgPracticasUno: Fragment() {

    private lateinit var binding: LayoutFrgPracticasUnoBinding

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        binding = LayoutFrgPracticasUnoBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.fabNext.setOnClickListener {
            Navigation
                ...
                .navigate(FrgPracticasUnoDirections.actionFrgPracticasUnoToFrgPracticasDos())
        }
    }
}
...
interface ZoomApi {
    ...
    @Retention(AnnotationRetention.SOURCE)
    @IntDef(
        com.ipn.esiatecamachalco.library.zoomimage.Alignment.BOTTOM,
        com.ipn.esiatecamachalco.library.zoomimage.Alignment.CENTER_VERTICAL,
        com.ipn.esiatecamachalco.library.zoomimage.Alignment.NONE_VERTICAL,
        com.ipn.esiatecamachalco.library.zoomimage.Alignment.TOP,
        com.ipn.esiatecamachalco.library.zoomimage.Alignment.LEFT,
        com.ipn.esiatecamachalco.library.zoomimage.Alignment.CENTER_HORIZONTAL,
        com.ipn.esiatecamachalco.library.zoomimage.Alignment.NONE_HORIZONTAL,
        com.ipn.esiatecamachalco.library.zoomimage.Alignment.RIGHT,
        com.ipn.esiatecamachalco.library.zoomimage.Alignment.CENTER,
        com.ipn.esiatecamachalco.library.zoomimage.Alignment.NONE,
        flag = true
    )
    ...
    /**
     * Sets the content alignment. Can be any of the constants defined in [com.ipn.esiatecamachalco.library.zoomimage.Alignment].
    ...
    companion object {
         ...
         */
        const val ALIGNMENT_DEFAULT = com.ipn.esiatecamachalco.library.zoomimage.Alignment.CENTER
    }
}
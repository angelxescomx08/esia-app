...
import com.ipn.esiatecamachalco.library.zoomimage.internal.StateController
import com.ipn.esiatecamachalco.library.zoomimage.internal.UpdatesDispatcher
import com.ipn.esiatecamachalco.library.zoomimage.internal.gestures.PinchDetector
import com.ipn.esiatecamachalco.library.zoomimage.internal.gestures.ScrollFlingDetector
import com.ipn.esiatecamachalco.library.zoomimage.internal.matrix.MatrixController
import com.ipn.esiatecamachalco.library.zoomimage.internal.matrix.MatrixUpdate
import com.ipn.esiatecamachalco.library.zoomimage.internal.movement.PanManager
import com.ipn.esiatecamachalco.library.zoomimage.internal.movement.ZoomManager
...
constructor(context: Context) : ZoomApi {
     ...
     * @param animate whether to animate the transition
     */
    override fun moveToCenter(@ZoomApi.Zoom zoom: Float?, animate: Boolean) {
     ...
     * @param animate  whether to animate the transition
     */
    override fun realZoomTo(@ZoomApi.RealZoom realZoom: Float, animate: Boolean) {
